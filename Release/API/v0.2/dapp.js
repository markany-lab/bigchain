...
const jsonBChannel = require('./jsons/BChannel.json')
const jsonBIdentity = require('./jsons/BIdentity.json')
const dappGatewayAddress = require('./jsons/gateway_dappchain_address_extdev-plasma-us1.json')
